...
Source0  : https://cpan.metacpan.org/authors/id/R/RJ/RJBS/Config-INI-0.027.tar.gz
...
%prep
%setup -q -n Config-INI-0.027
cd %{_builddir}/Config-INI-0.027
...
cp %{_builddir}/Config-INI-0.027/LICENSE %{buildroot}/usr/share/package-licenses/perl-Config-INI/27e158af651b5a0cac04a11de0e4ab7abe601a0b
if test -f Makefile.PL; then
